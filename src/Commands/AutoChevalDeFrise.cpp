...
AutoChevalDeFrise::AutoChevalDeFrise() {
	...
	AddParallel(new AutoDrivePower(-.85, 0,  false, false, true));
	AddParallel(new SetArmPosition(c_armTravelPosition));
	AddSequential(new DefenseCrossedSmart(PitchStepDecrease, false, false));
	AddSequential(new WaveWait(.25));
	AddParallel(new AutoDrivePower(0.5, 0, false, false, false));
	AddSequential(new WaveWait(.25));
	AddParallel(new AutoDrivePower(0, 0, false, false, false));
	AddSequential(new SetArmPosition(c_armIntakePosition));
	AddSequential(new WaveWait(.25));
//	AddSequential(new AutoDrivePower(-.5, 90, false, false, false)); // NEEDS TO BE TESTED
	AddSequential(new SetHeading(180, false));
