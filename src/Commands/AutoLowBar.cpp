...
// END AUTOGENERATED CODE, SOURCE=ROBOTBUILDER ID=CONSTRUCTOR
    ...
    // arm.+-000000000000000000000000000000000000000000000000000000
	...
	AddParallel(new FirePrepSequence(Hood_Stow, Turret_Straight, Long_Shot));
	//AddSequential(new SetHoodPosition( Hood_Stow));
	AddParallel(new AutoDrivePower(.8, 0, true, false));
	...
	AddParallel(new SetArmPosition(c_armLowPosition+1)); //For Low Bar Sensing MAYBE LOWER A BIT
	AddSequential(new AutoDrivePower(0, 0, false, false));
	AddSequential(new AutoDrivePower(-.55, 0, false, true));
	//AddSequential(new SetArmPosition(c_armLowPosition + 2)); //for Low Bar sensing
	AddParallel(new AutoDrivePower(-.3, 0, false, false)); //Keep pressed against the low bar
