...
OI::OI() {
  ...
  //  operatorRightTrigger
    //operatorLeftTrigger.reset(new JoystickButton(operatorJoystick.get()), 2);
   // operatorStart->WhenReleased(new AutoIntake());
    operatorSelect->WhenReleased(new Shoot());
   // operatorRightBumper->WhenPressed(new FireSequence());
   ...
   // operatorRightBumper->WhenPressed(new SetGrappleState(Grapple_Release));
    ...
    operatorY->WhenReleased(new SetShooterWheelSpeed(Long_Shot));
    operatorX->WhenReleased(new SetShooterWheelSpeed(Short_Shot));
...
//    operatorB->WhenReleased(new SetHoodPositionSequence(Hood_Low));
   ...
   // driverRightTrigger->WhileHeld(new IntakeSequence());
   // driverLeftTrigger
   ...
   // driverRightBumper->WhenReleased(new SetTurretCylinder(Turret_Straight));
    driverRightBumper->WhenPressed(new IntakePositionSequence()); // I don't know how to do triggers so this SHOULD eventually be on right trigger
    driverLeftBumper->WhenPressed(new AlignSequence());
    //driverLeftBumper->WhenReleased(new SetTurretCylinder(Turret_Angled));
//    driverY->WhenReleased(new SetShooterWheelSpeed(Long_Shot));
//    driverX->WhenReleased(new SetShooterWheelSpeed(Short_Shot));
    //driverB->WhenReleased(new ButtonWheelSpeed(Increase_1));
   // driverA->WhenReleased(new ButtonWheelSpeed(Decrease_1));
    driverA->WhenReleased(new LowBarPrep());
