...
OI::OI() {
    ...
    driverY->WhenReleased(new AutonomousCommand());
    driverX.reset(new JoystickButton(driverJoystick.get(), 3));
    driverX->WhenReleased(new AutonomousCommand());
    driverB.reset(new JoystickButton(driverJoystick.get(), 2));
    driverB->WhenReleased(new AutonomousCommand());
    driverA.reset(new JoystickButton(driverJoystick.get(), 1));
    driverA->WhenReleased(new AutonomousCommand());
