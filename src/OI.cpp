...
#include "Commands/GrappleDeploy.h"
...
OI::OI() {
  ...
  //  operatorStart.reset(new JoystickButton(operatorJoystick.get(), 8));
    ...
    operatorB->WhenPressed(new SetClimbState(Climb_Deploy));
    operatorB->WhenReleased(new SetClimbState(Climb_Hold));
    operatorY->WhenPressed(new GrappleDeploy());


   // operatorB->WhenPressed(new FirePrepSequence(Hood_Medium, Turret_Straight, Bad_Ball_Shot));
//    operatorB->WhenPressed(new FirePrepSequence(Hood_Medium, Turret_Straight, OVER_NINE_K));
   // operatorB->WhenReleased(new FirePrepSequence(Hood_Stow, Turret_Straight, Idle_Shot));
