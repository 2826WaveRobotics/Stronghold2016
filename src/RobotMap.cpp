...
std::shared_ptr<Talon> RobotMap::lightOutputRight;
std::shared_ptr<Talon> RobotMap::lightOutputLeft;
...
//    lw->AddActuator("GrappleClimb", "ClimbRelease", grappleClimbClimbRelease);
    ...
    lightOutputRight.reset(new Talon(0));
    lightOutputLeft.reset(new Talon(1));
}
