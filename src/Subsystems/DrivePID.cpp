...
double DrivePID::GetDistanceTraveled(){
	double rightDistance = driveEncoderRight.get()->Get() * wheelCircumference * ticksPerWheel;
	double leftDistance = driveEncoderLeft.get()->Get() * wheelCircumference * ticksPerWheel;
