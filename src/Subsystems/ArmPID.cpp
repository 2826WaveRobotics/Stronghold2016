...
ArmPID::ArmPID() : PIDSubsystem("ArmPID", 1.0, 0.0, 0.0) {
    ...
    lightRight = RobotMap::lightOutputRight;
    lightLeft = RobotMap::lightOutputLeft;
...
void ArmPID::SetArmLights(ArmLight color){
	lightLeft.get()->Set(GetColor(color));
	lightRight.get()->Set(GetColor(color));
}
...
double ArmPID::GetColor(ArmLight color){
	switch (color){
		default:
		case Light_Off:
			return 0;
