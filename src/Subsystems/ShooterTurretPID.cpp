...
void ShooterTurretPID::UsePIDOutput(double output) {
	...
	// BEGIN AUTOGENERATED CODE, SOURC xxxxE=ROBOTBUILDER ID=OUTPUT
...
void ShooterTurretPID::SetTurretCylinder(TurretState state){
	...
	else if(state == Turret_Angled)
	{
		if(Robot::armPID.get()->GetArmAngle() < 1.0){
			Robot::armPID.get()->SetArmAngle(1.5);
		}
